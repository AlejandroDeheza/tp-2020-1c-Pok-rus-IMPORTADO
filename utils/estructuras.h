...
typedef enum
{
	...
	UNSUBSCRIBE_NEW_POKEMON = 31,
	UNSUBSCRIBE_APPEARED_POKEMON = 32,
	UNSUBSCRIBE_CATCH_POKEMON = 33,
	UNSUBSCRIBE_CAUGHT_POKEMON = 34,
	UNSUBSCRIBE_GET_POKEMON = 35,
	UNSUBSCRIBE_LOCALIZED_POKEMON = 36
}op_code;
